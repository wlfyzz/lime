...
import { faUsers, faMusic, faChartLine, faMicrophone, faBroadcastTower, faCalendarAlt, faChartBar, faCog } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex">
        <Sidebar className="w-64 bg-lime-950 text-lime-100">
          <SidebarHeader className="p-4">
            <h2 className="text-2xl font-bold text-lime-300">Staff Menu</h2>
          </SidebarHeader>
          <SidebarContent>
            <SidebarGroup>
              <SidebarGroupContent>
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton onClick={() => handleNavigation('/staff/broadcast')} className="w-full flex items-center space-x-2 text-lime-100 hover:bg-lime-900">
                      <FontAwesomeIcon icon={faBroadcastTower} className="w-4 h-4" />
                      <span>Broadcast</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton onClick={() => handleNavigation('/staff/timetable')} className="w-full flex items-center space-x-2 text-lime-100 hover:bg-lime-900">
                      <FontAwesomeIcon icon={faCalendarAlt} className="w-4 h-4" />
                      <span>Timetable</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton onClick={() => handleNavigation('/staff/analytics')} className="w-full flex items-center space-x-2 text-lime-100 hover:bg-lime-900">
                      <FontAwesomeIcon icon={faChartBar} className="w-4 h-4" />
                      <span>Analytics</span>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton onClick={() => handleNavigation('/staff/settings')} className="w-full flex items-center space-x-2 text-lime-100 hover:bg-lime-900">
        ...
        <div className="flex-1 bg-gradient-to-br from-lime-900 to-lime-950 text-lime-100 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="bg-lime-950 border-lime-700">
              ...
              <CardContent>
                <Button onClick={() => handleNavigation('/staff/broadcast')} className="w-full bg-lime-600 hover:bg-lime-500 text-lime-950">Start Broadcasting</Button>
              </CardContent>
            </Card>
          </div>
        </div>
